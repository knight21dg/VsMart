...
import { ArrowLeft, Eye, EyeOff, KeyRound, Loader2, Store } from "lucide-react";
...
export default function ForgotPasswordPage() {
  ...
  async function handleRequest(e: React.FormEvent) {
    ...
    try {
      ...
      // The endpoint is generic-success by design; only network/server faults land here.
      setError(
      ...
      <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-gradient-to-br from-[#7cb342] via-[#558b2f] to-[#1b3d12] p-12 text-white lg:flex">
        ...
        <div className="relative max-w-md">
          ...
          <p className="mt-6 text-base leading-relaxed text-white/80">
            No worries — we&apos;ll email a one-time reset code to your registered
            address so you can set a new password and get back into your Store Panel.
          </p>
            ...
            <form onSubmit={handleRequest} className="mt-8 space-y-5">
              <div className="space-y-1.5">
                ...
                <p className="text-xs text-muted-foreground">
                  We&apos;ll email a reset code if this address is registered.
                </p>
              </div>
