          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Text(context.l10n.catalogFilters,
              ...
              SwitchListTile.adaptive(
                ...
                title: Text(context.l10n.catalogInStockOnly,
                    style: AppTypography.bodyLarge),
                activeColor: vs.brand,
              ),
              const Divider(),
              AppSpacing.vGapSm,
              Text(context.l10n.catalogPrice, style: AppTypography.titleMedium),
              AppSpacing.vGapSm,
              Wrap(
              ...
              AppSpacing.vGapLg,
              Text(context.l10n.catalogMinDiscount,
              ...
              if (widget.brands.isNotEmpty) ...[
                AppSpacing.vGapLg,
                Text(context.l10n.catalogBrand,
                    style: AppTypography.titleMedium),
                AppSpacing.vGapSm,
                Wrap(
                  spacing: AppSpacing.sm,
              ...
              AppSpacing.vGapXl,
              VSButton(
                label: context.l10n.catalogApplyFilters,
