...
class _ProductListingScreenState extends ConsumerState<ProductListingScreen> {
  ...
  late final String? _departmentId = widget.departmentId ?? widget.categoryId;
              ...
              Expanded(
                child: RefreshIndicator(
                  ...
                  child: _Body(
                    ...
                    onAdd: (p) {
                      addToCartOrChoose(context, ref, p, source: 'listing');
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          VSFilterChip(
            label: context.l10n.catalogSort,
            icon: Icons.swap_vert_rounded,
            onTap: onSort,
          ),
          AppSpacing.hGapSm,
          VSFilterChip(
            label: context.l10n.catalogFilter,
...
class _ActiveFilters extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final chips = state.filter.activeChips(context.l10n);
    return SizedBox(
      height: 40,
      ...
      slivers: [
        ...
        if (state.loading && state.products.isEmpty)
          ...
          SliverFillRemaining(
            hasScrollBody: false,
            child: VSEmptyState(
              title: context.l10n.catalogNoProductsFound,
              message: context.l10n.catalogAdjustFilters,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(context.l10n.catalogHandpickedDaily,
