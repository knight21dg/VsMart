...
class Category extends Equatable {
  ...
  /// Whether this category has sub-categories beneath it. Drives the store-tree
  /// browser: a branch drills into another rail level, a leaf opens its products.
  /// Only the store-tree endpoint reports it; elsewhere it stays false.
  final bool hasChildren;

  @override
  List<Object?> get props =>
      [id, name, productCount, imageUrl, iconName, parentId, hasChildren];
}
