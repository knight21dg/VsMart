...
import '../entities/cibil_report.dart';
...
abstract interface class CreditRepository {
  ...
  Future<Either<Failure, CibilReport?>> getLatestCibil();

  /// Fetch (and store) the CIBIL score for [mobile] after explicit [consent].
  Future<Either<Failure, CibilReport>> checkCibil({
