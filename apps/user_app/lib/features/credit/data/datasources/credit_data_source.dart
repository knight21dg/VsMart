...
abstract interface class CreditDataSource {
  ...
  /// The customer's most recent stored CIBIL report, or null if never checked.
  Future<CibilReport?> getLatestCibil();

  /// Fetch (and store) the CIBIL score for [mobile] after explicit [consent].
  Future<CibilReport> checkCibil({required String mobile, required bool consent});
}
