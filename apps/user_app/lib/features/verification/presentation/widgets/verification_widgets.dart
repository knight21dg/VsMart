  ...
  Widget _empty(BuildContext context) {
    ...
    return Column(
      ...
      children: [
          ...
          children: [
            Expanded(
              child: _SourceButton(
                ...
                label: context.l10n.verifyCamera,
                onTap: onCapture,
              ),
            ),
            AppSpacing.hGapMd,
            Expanded(
              child: _SourceButton(
                ...
                label: context.l10n.verifyGallery,
                onTap: onPickGallery,
              ),
            ),
          ],
        ...
        AppSpacing.vGapSm,
        Text(context.l10n.verifyPhotoFormat,
  ...
  Widget _uploading(BuildContext context) {
    return Row(
      children: [
        ...
        AppSpacing.hGapMd,
        Expanded(
            child: Text(context.l10n.verificationUploading(title),
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(context.l10n.verifyUploaded,
                  style:
              ...
              Row(
                children: [
                  GestureDetector(
                    onTap: onCapture,
                    child: Text(context.l10n.verifyRetake,
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(context.l10n.verifyUploadFailed,
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Text(context.l10n.verificationLimitLabel,
                style:
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Text(context.l10n.verifyStepOf(step, total),
                  style: AppTypography.labelMedium
