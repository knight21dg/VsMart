...
class VerificationController extends Notifier<VerificationDraft> {
  ...
  /// Record that residence proof was captured (photo + real device GPS) so the
  /// residence step counts toward [VerificationDraft.isReadyToSubmit] and shows
  /// in the review summary. The photo/coords are already POSTed to the backend
  /// by the residence step itself.
  void setResidence({
