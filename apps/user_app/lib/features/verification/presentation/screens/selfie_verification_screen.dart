...
class _SelfieVerificationScreenState
  ...
  Future<void> _capture() async {
    ...
    try {
      ...
      if (mounted) {
        context.showSnack(context.l10n.verificationCaptureFailed,
            isError: true);
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: VSAppBar(title: context.l10n.verifyFace),
  ...
  Widget _content(BuildContext context) {
    ...
    if (!_ready) {
      return VSLoadingView(message: context.l10n.verifyStartingCamera);
    }
  ...
  Widget _cameraView(BuildContext context) {
    ...
    return Column(
      children: [
        AppSpacing.vGapSm,
        Text(context.l10n.verifyFaceVisible,
        ...
        Padding(
          padding: AppSpacing.screenHorizontal,
          child: VSButton(
            label: context.l10n.verifyCapture,
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              AppSpacing.hGapSm,
              Text(context.l10n.verificationSelfieCaptured,
            ...
            children: [
              Expanded(
                child: VSOutlinedButton(
                    label: context.l10n.verifyRetake, onPressed: _retake),
              ),
              AppSpacing.hGapMd,
              Expanded(
                child: VSButton(
  ...
  Widget _permission(BuildContext context) {
    return VSEmptyState(
      title: context.l10n.verifyCameraNeeded,
      message:
