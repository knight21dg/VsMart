          ...
          children: [
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  AppSpacing.vGapLg,
                  Text(context.l10n.verifyAppSubmitted,
                      textAlign: TextAlign.center,
                      style: AppTypography.headlineLarge),
                  AppSpacing.vGapSm,
                  Text(
                    context.l10n.verificationReviewingDetails,
                    textAlign: TextAlign.center,
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        _Row(
                            label: context.l10n.verifyApplicationId,
                            value: app?.applicationId ?? '—'),
                        const Divider(height: AppSpacing.xl),
                        _Row(
                          label: context.l10n.verifySubmittedOn,
                        ...
                        const Divider(height: AppSpacing.xl),
                        _Row(
                          label: context.l10n.verifyExpectedReview,
                          value: 'Within ${app?.expectedReviewDays ?? 2} days',
                        ),
                        const Divider(height: AppSpacing.xl),
                        _Row(
                          label: context.l10n.verifyCurrentStatus,
                          value: context.l10n.verifyStatusPending,
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            context.l10n.verificationCreditReflectionNote,
            ...
            Padding(
              ...
              child: Column(
                children: [
                  VSButton(
                    label: context.l10n.verifyTrackApp,
                    ...
                    children: [
                      Expanded(
                        child: VSOutlinedButton(
                          label: context.l10n.authGoToHome,
