...
class _IdentityVerificationScreenState
  ...
  void _continue() {
    ...
    if (draft.aadhaarFrontPath == null ||
        ...
        draft.panPath == null) {
      context.showSnack(context.l10n.verificationUploadAllDocs, isError: true);
      return;
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: VSAppBar(title: context.l10n.verifyIdentityVerification),
      body: Column(
        children: [
            ...
            child: Form(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  AppSpacing.vGapLg,
                  Text(context.l10n.verifyUploadDocs,
        ...
        children: [
          Row(
            children: [
              ...
              AppSpacing.hGapSm,
              Text(context.l10n.verificationWhyDocumentsTitle,
