...
abstract final class VerificationDraftModel {
  ...
  static Map<String, dynamic> toJson(VerificationDraft d) => {
        ...
        'residencePhotoPath': d.residencePhotoPath,
        'residenceLatitude': d.residenceLatitude,
        'residenceLongitude': d.residenceLongitude,
  ...
  static VerificationDraft fromJson(Map<String, dynamic> j) => VerificationDraft(
        ...
        residencePhotoPath: j['residencePhotoPath'] as String?,
        residenceLatitude: (j['residenceLatitude'] as num?)?.toDouble(),
        residenceLongitude: (j['residenceLongitude'] as num?)?.toDouble(),
