          ...
          data: (items) {
            if (items.isEmpty) {
              return VSEmptyState(
                ...
                message: context.l10n.wishlistEmptyBody,
                icon: Icons.favorite_border_rounded,
                actionLabel: context.l10n.wishlistBrowseProducts,
            ...
            return RefreshIndicator(
              ...
              child: ListView(
                ...
                children: [
                Text(context.l10n.wishlistTitle,
                ...
                if (shown.isEmpty)
                  Padding(
                    ...
                    child: Center(
                      child: Text(context.l10n.wishlistNoMatch,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(context.l10n.wishlistTotalValue,
          ...
          Row(
            children: [
              Expanded(
                child: _Stat(
                    label: context.l10n.wishlistSaved,
                    value: '${items.length}',
                    faint: faint),
              ),
              Expanded(
                child: _Stat(
                    label: context.l10n.wishlistPriceDropAlerts,
                    value: '$drops',
                    faint: faint),
              ),
            ],
...
class _FilterTabs extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final tabs = <(_WishFilter, String, IconData?)>[
      (_WishFilter.all, context.l10n.catalogAll, null),
      (_WishFilter.inStock, context.l10n.catalogInStock, null),
      (_WishFilter.priceDrop, context.l10n.wishlistPriceDrop,
...
class _WishlistCard extends ConsumerWidget {
  ...
  void _add(BuildContext context, WidgetRef ref) {
    ...
    addToCartOrChoose(context, ref, product, source: 'wishlist');
  }
            ...
            children: [
                  ...
                  if (discount > 0)
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: Text(context.l10n.discountPercentOff(discount),
                    ...
                    Row(
                      children: [
                        ...
                        if (discount > 0) ...[
                          ...
                          AppSpacing.hGapSm,
                          Text(context.l10n.discountPercentOff(discount),
                              style: AppTypography.labelSmall
              ...
              _Menu(
                onRemove: () {
                  ...
                  context.showSnack(context.l10n.wishlistRemoved(p.name));
                },
            ...
            children: [
              ...
              Expanded(
                child: VSOutlinedButton(
                  label: context.l10n.commonBuyNow,
                  onPressed: p.inStock
                      ? () {
                          _add(context, ref);
...
class _Menu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PopupMenuButton<int>(
      ...
      itemBuilder: (context) => [
        PopupMenuItem(value: 0, child: Text(context.l10n.wishlistViewProduct)),
        PopupMenuItem(value: 1, child: Text(context.l10n.commonRemove)),
      ],
    );
  }
}
