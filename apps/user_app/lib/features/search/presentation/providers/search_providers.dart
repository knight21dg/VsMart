...
/// The COMMITTED search query — set on submit / suggestion tap. Drives the full
/// results grid.
final searchQueryProvider = StateProvider<String>((ref) => '');

/// The live typed text (debounced by the search field). Drives the as-you-type
/// autocomplete suggestions, which are shown until a query is committed.
