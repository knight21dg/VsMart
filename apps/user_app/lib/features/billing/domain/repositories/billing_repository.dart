...
abstract interface class BillingRepository {
  /// Authoritative limit + outstanding from the backend (record type is
  /// structural, so it matches the data source's CreditSummary without coupling
  /// the domain layer to it).
  ...
  /// [idempotencyKey] should be stable across retries of the same request.
