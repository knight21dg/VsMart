...
class InvoicesScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: VSAppBar(title: context.l10n.billingInvoices),
      body: invoicesAsync.when(
        ...
        data: (invoices) {
          if (invoices.isEmpty) {
            return VSEmptyState(
              title: context.l10n.billingNoInvoices,
              message: context.l10n.billingInvoicesAppearHere,
