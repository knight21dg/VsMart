  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(context.l10n.billingCreditTab,
            style: AppTypography.headlineSmall.copyWith(color: vs.brand)),
        actions: [
          if (creditActive)
            IconButton(
              icon: const Icon(Icons.receipt_long_rounded),
              tooltip: context.l10n.creditStatements,
...
class _CreditLockedView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final (IconData icon, String title, String body, String cta, String route) =
        switch (status) {
      // KYC drives the copy (identity is the precondition), but every CTA leads
      // to the credit application — that's the thing that actually gets a limit
      // assigned. Sending these to /kyc left customers on a document checklist
      // with no way to ask for credit.
      KycStatus.pending => (
          Icons.hourglass_top_rounded,
          context.l10n.creditAppUnderReview,
          context.l10n.billingCreditPendingBody,
          context.l10n.billingViewStatus,
          RouteNames.verificationStatus,
        ),
      KycStatus.rejected => (
          Icons.error_outline_rounded,
          context.l10n.creditAppNotApproved,
          context.l10n.billingCreditRejectedBody,
      ...
      KycStatus.verified => (
          ...
          context.l10n.billingCreditApplyBody,
          context.l10n.billingApplyForCredit,
          RouteNames.creditApplicationStatus,
        ),
      // Identity not verified yet — KYC first, then the credit application.
      _ => (
          Icons.credit_card_rounded,
          context.l10n.billingUnlockCredit,
          context.l10n.billingCreditApplyBody,
      ...
      children: [
        ...
        Row(
          children: [
            ...
            Expanded(
              child: Text(
                context.l10n.billingCreditEncryptedNote,
...
class _CreditBenefits extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final vs = context.vsColors;
    final items = [
      (Icons.shopping_bag_outlined, context.l10n.billingBenefitShopPayLater),
      (Icons.calendar_month_rounded, context.l10n.billingBenefitFlexiblePlans),
      (Icons.percent_rounded, context.l10n.billingBenefitMemberOffers),
      (Icons.speed_rounded, context.l10n.billingBenefitBuildScore),
    ];
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(context.l10n.billingWhyVsCredit,
      ...
      children: [
        ...
        Row(
          children: [
            Expanded(
              child: VSButton(
                label: context.l10n.billingMakePayment,
            ...
            Expanded(
              child: VSOutlinedButton(
                label: context.l10n.billingViewStatement,
        ...
        AppSpacing.vGapLg,
        _CibilScoreCard(
          onTap: () => context.pushNamed(RouteNames.cibilScore),
        ),
        AppSpacing.vGapLg,
...
/// Entry point to the self-service CIBIL / credit-score check (route
/// [RouteNames.cibilScore]). Kept on the live credit surface so the completed
/// [CibilScoreScreen] is reachable from the dashboard.
class _CibilScoreCard extends StatelessWidget {
  const _CibilScoreCard({required this.onTap});
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Icon(Icons.speed_rounded, color: vs.trust, size: 28),
            AppSpacing.hGapMd,
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  ...
                  AppSpacing.vGapXs,
                  Text('Free, instant, no impact on your score',
                      style: AppTypography.bodySmall
                          .copyWith(color: vs.textSecondary)),
                ],
              ),
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                    context.l10n.billingPercentUsed(
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text(context.l10n.billingUsedAmount(used.asCurrency),
                  style: AppTypography.bodySmall.copyWith(color: faint)),
              Text(context.l10n.billingTotalLimitAmount(limit.asCurrency),
                  style: AppTypography.bodySmall.copyWith(color: faint)),
            ],
          ),
          AppSpacing.vGapSm,
      ...
      child: Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text(context.l10n.billingCurrentBill,
                  style: AppTypography.titleLarge),
              VSStatusChip(
                label: isOverdue
                    ? context.l10n.billingOverdue
                    : context.l10n.creditDueOn(dueDate),
          ...
          Row(
            ...
            children: [
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(context.l10n.billingTotalAmountDue,
                      style: AppTypography.bodySmall
                          .copyWith(color: vs.textSecondary)),
          ...
          AppSpacing.vGapMd,
          VSButton(
            label: context.l10n.billingPayNow,
            icon: Icons.payments_rounded,
            onPressed: onPay,
          ),
        ],
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(context.l10n.billingAllCaughtUp,
                    style: AppTypography.titleMedium),
                Text(context.l10n.billingNoPendingDues,
                    style: AppTypography.bodySmall
                        .copyWith(color: vs.textSecondary)),
              ],
            ),
      ...
      children: [
        Row(
          children: [
            _ActionButton(
              icon: Icons.description_outlined,
              label: context.l10n.creditStatements,
              onTap: () => context.pushNamed(RouteNames.statements),
            ),
            AppSpacing.hGapMd,
            _ActionButton(
              icon: Icons.receipt_outlined,
              label: context.l10n.billingInvoices,
        ...
        Row(
          children: [
            _ActionButton(
              ...
              label: context.l10n.creditPaymentHistory,
              onTap: () => context.pushNamed(RouteNames.paymentHistory),
            ),
            AppSpacing.hGapMd,
            _ActionButton(
              icon: Icons.local_atm_outlined,
              label: context.l10n.billingCollections,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(context.l10n.billingRecentActivity,
              style: AppTypography.titleLarge),
          AppSpacing.vGapSm,
          if (transactions.isEmpty)
            Padding(
              padding: const EdgeInsets.symmetric(vertical: AppSpacing.lg),
              child: Text(context.l10n.billingNoTransactions,
