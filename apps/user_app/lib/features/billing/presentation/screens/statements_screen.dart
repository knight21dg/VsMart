...
class StatementsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: VSAppBar(title: context.l10n.creditStatements),
      body: statementsAsync.when(
        ...
        data: (statements) {
          if (statements.isEmpty) {
            return VSEmptyState(
              title: context.l10n.billingNoStatements,
              message: context.l10n.billingStatementsAppearHere,
...
class _StatementCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final (tone, label) = statement.paid
        ? (VSStatusTone.success, context.l10n.payStatusPaid)
        : statement.isOverdue
            ? (VSStatusTone.danger, context.l10n.billingOverdue)
            : (VSStatusTone.warning, context.l10n.billingStatusDue);
    return InkWell(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                _Metric(
                    label: context.l10n.billingAmountDue,
