              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      overdue
                          ? context.l10n.codeOverduePaymentTitle
                          : context.l10n.billingPaymentDue(due),
                      style: AppTypography.labelLarge.copyWith(color: accent),
                    ),
                    Text(
                      statement.minimumDue > 0
                          ? context.l10n.billingAmountDueMin(
                              statement.amountDue.asCurrency,
                              statement.minimumDue.asCurrency)
                          : context.l10n.billingAmountDueShort(
                              statement.amountDue.asCurrency),
