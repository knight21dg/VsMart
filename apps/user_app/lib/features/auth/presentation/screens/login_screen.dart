...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Future<void> _sendOtp() async {
    ...
    if (ok) {
      ...
      // Route the (possibly actionable) backend failure through the central
      // presenter so codes like account gates / rate limits drive the right UX.
      final failure = ref.read(authControllerProvider).failure;
      presentFailure(
        context,
        ref,
        failure ?? const UnknownFailure('Could not send OTP. Please try again.'),
        onRetry: _sendOtp,
      );
    }
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    VSPhoneField(
                      ...
                      label: context.l10n.authPhoneHint,
        ...
        Row(
          ...
          children: [
            GestureDetector(
              ...
              child: Text(context.l10n.authTermsOfService, style: emphasis),
            ),
            Padding(
            ...
            GestureDetector(
              ...
              child: Text(context.l10n.accountPrivacy, style: emphasis),
            ),
          ],
        ),
      ],
