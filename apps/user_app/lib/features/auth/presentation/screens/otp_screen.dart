...
class _OtpScreenState extends ConsumerState<OtpScreen> {
  ...
  Future<void> _verify() async {
    ...
    if (ok) {
      ...
      // Keep the inline chip for the common wrong-code case, but route any
      // actionable backend code (lockout, expired, logout…) through the presenter.
  ...
  Future<void> _resend() async {
    ...
    if (ok) {
      ...
      presentFailure(
        ...
        ref,
        failure ??
            const UnknownFailure('Could not resend the code. Please try again.'),
        onRetry: _resend,
      );
    }
  }
            ...
            child: Column(
              children: [
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              context.l10n.authUseDifferentNumber,
                ...
                Padding(
                  ...
                  child: VSButton(
                    label: context.l10n.authVerifyContinue,
