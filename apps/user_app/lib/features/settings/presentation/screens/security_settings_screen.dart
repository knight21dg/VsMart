...
class SecuritySettingsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: VSAppBar(title: context.l10n.settingsPrivacy),
      body: SafeArea(
        top: false,
        child: ListView(
            ...
            _Group(
              ...
              rows: [
                _ToggleRow(
                  ...
                  label: context.l10n.settingsBiometricLock,
                  subtitle: context.l10n.settingsBiometricLockSubtitle,
            ...
            _Group(
              ...
              rows: [
                _ToggleRow(
                  ...
                  label: context.l10n.settingsNotifyNewLogin,
                  subtitle: context.l10n.settingsNotifyNewLoginSubtitle,
                  value: prefs.notifyNewLogin,
                  onChanged: controller.setNotifyNewLogin,
                ),
                _ToggleRow(
                  icon: Icons.lock_reset_rounded,
                  label: context.l10n.settingsNotifyProfileChanges,
                  subtitle: context.l10n.settingsNotifyProfileChangesSubtitle,
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      context.l10n.settingsOtpSecurityNote,
