...
import '../entities/reorder_line.dart';
...
abstract interface class OrderRepository {
  ...
  /// What reordering this order would put in the cart (read-only preview).
  Future<Either<Failure, ReorderPlan>> reorderPreview(String id);
}
