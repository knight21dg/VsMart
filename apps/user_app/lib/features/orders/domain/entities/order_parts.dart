...
class OrderPayment extends Equatable {
  ...
  /// Taken through a payment instrument, net of refunds. Excludes the VS Credit
  /// leg, which is reversed in the credit ledger rather than refunded.
  final num amountPaid;

  /// Paid back out. A cancelled order with 0 here has NOT been refunded yet —
  /// the distinction the customer actually wants.
  final num amountRefunded;

  bool get usedCredit => creditUsed > 0;
  bool get hasRefund => amountRefunded > 0;

  @override
  List<Object?> get props =>
      [method, status, amount, creditUsed, amountPaid, amountRefunded];
}
