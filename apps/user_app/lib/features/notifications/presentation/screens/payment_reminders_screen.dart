...
class _PaymentRemindersScreenState
  ...
  Future<void> _save() async {
    ...
    context.showSnack(
      ok
          ? context.l10n.paymentReminderSaved
          : context.l10n.paymentReminderSaveError,
      isError: !ok,
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: VSAppBar(title: context.l10n.paymentReminderTitle),
      body: SafeArea(
        top: false,
        child: prefsAsync.when(
          loading: () => const Center(child: CircularProgressIndicator()),
          error: (_, __) => VSErrorView(
            message: context.l10n.paymentReminderLoadError,
  ...
  Widget _form(BuildContext context) {
    ...
    return RefreshIndicator(
      onRefresh: () async {
        // Re-seed the form from the freshly fetched server preferences.
        _seeded = false;
      ...
      child: ListView(
        ...
        children: [
        Text(l10n.paymentReminderHeadline, style: AppTypography.headlineLarge),
        AppSpacing.vGapXs,
        Text(
          l10n.paymentReminderSubtitle,
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(l10n.paymentReminderEnableTitle,
                        style: AppTypography.titleMedium),
                    AppSpacing.vGapXs,
                    Text(
                      l10n.paymentReminderEnableSubtitle,
        ...
        // ----- Timing selection -----
        _SectionTitle(l10n.paymentReminderWhenTitle),
        AppSpacing.vGapMd,
        Opacity(
              ...
              children: [
                Expanded(
                  child: _TimingCard(
                    ...
                    title: l10n.paymentReminderThreeDays,
                    subtitle: l10n.paymentReminderThreeDaysSub,
                ...
                Expanded(
                  child: _TimingCard(
                    ...
                    title: l10n.paymentReminderOneDay,
                    subtitle: l10n.paymentReminderOneDaySub,
              ...
              children: [
                Expanded(
                  child: _TimingCard(
                    ...
                    title: l10n.paymentReminderOnDueDate,
                    subtitle: l10n.paymentReminderOnDueDateSub,
                ...
                Expanded(
                  child: _TimingCard(
                    ...
                    title: l10n.paymentReminderWeekBefore,
                    subtitle: l10n.paymentReminderWeekBeforeSub,
        ...
        // ----- Channels -----
        _SectionTitle(l10n.paymentReminderHowTitle),
        AppSpacing.vGapMd,
        Opacity(
          opacity: disabled ? 0.5 : 1,
          child: IgnorePointer(
              ...
              child: Column(
                children: [
                  _ChannelRow(
                    ...
                    iconColor: vs.brand,
                    tint: vs.brandTint,
                    title: l10n.paymentReminderWhatsApp,
                    subtitle: l10n.paymentReminderWhatsAppSub,
                    value: _whatsApp,
                  ...
                  _ChannelRow(
                    ...
                    iconColor: vs.trust,
                    tint: vs.trustTint,
                    title: l10n.paymentReminderPush,
                    subtitle: l10n.paymentReminderPushSub,
                    value: _push,
                  ...
                  _ChannelRow(
                    ...
                    iconColor: vs.offer,
                    tint: vs.offerTint,
                    title: l10n.paymentReminderSms,
                    subtitle: l10n.paymentReminderSmsSub,
                    value: _sms,
        ...
        // ----- Preferred time -----
        _SectionTitle(l10n.paymentReminderPreferredTime),
        AppSpacing.vGapMd,
        Opacity(
          opacity: disabled ? 0.5 : 1,
          child: IgnorePointer(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(l10n.paymentReminderTimeOfDay,
                                style: AppTypography.titleMedium),
                            AppSpacing.vGapXs,
                            Text(
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  l10n.paymentReminderInfoBanner,
        ...
        // ----- Save -----
        VSButton(
          label: l10n.paymentReminderSave,
          isLoading: _saving,
          onPressed: _save,
        ),
      ],
