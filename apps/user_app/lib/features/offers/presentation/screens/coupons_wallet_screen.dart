...
class CouponsWalletScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: VSAppBar(title: context.l10n.offersCouponsTitle),
      body: SafeArea(
        top: false,
        child: coupons.when(
        ...
        if (active.isEmpty)
          Padding(
            ...
            child: VSEmptyState(
              ...
              title: context.l10n.offersNoCouponsYet,
              message: context.l10n.offersCouponsAppearHere,
            ),
          )
        else ...[
          Text(context.l10n.offersAvailableCoupons,
        ...
        children: [
          Expanded(
            child: Column(
              ...
              children: [
                Text(context.l10n.offersSaveMore,
...
class _CouponTicket extends ConsumerWidget {
  ...
  void _copy(BuildContext context) {
    ...
    context.showSnack(context.l10n.offersCodeCopied);
  }

  /// Carry the coupon into checkout — it auto-applies (with server validation)
  /// when the shopper reaches checkout, so they never re-type it. Lands on the
  /// cart to continue shopping.
  void _apply(BuildContext context, WidgetRef ref) {
    ref.read(pendingCouponProvider.notifier).state = coupon.code;
    context.showSnack('${coupon.code} will be applied at checkout');
...
class _HowToUseCard extends StatelessWidget {
  ...
  static const _steps = [
    ...
    (Icons.touch_app_rounded, 'Tap a coupon to apply it (or Copy the code)'),
    (Icons.local_offer_rounded, 'It applies automatically at checkout'),
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(context.l10n.offersHowToUse, style: AppTypography.titleMedium),
          AppSpacing.vGapMd,
