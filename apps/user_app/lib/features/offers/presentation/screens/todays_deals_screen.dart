...
class TodaysDealsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: VSAppBar(title: context.l10n.offersTodaysDeals),
      body: SafeArea(
        top: false,
        child: deals.when(
          loading: () => VSLoadingView(message: context.l10n.offersLoadingDeals),
          ...
          data: (items) {
            if (items.isEmpty) {
              return VSEmptyState(
                ...
                title: context.l10n.offersNoDeals,
                message: context.l10n.offersCheckBackSoon,
              );
            }
            ...
            return RefreshIndicator(
              ...
              children: [
                ...
                _SectionHeader(
                  ...
                  label: context.l10n.offersSellingFast,
                ),
                AppSpacing.vGapSm,
                _SellingFastCard(
                  offer: featured,
                ...
                if (grid.isNotEmpty) ...[
                  ...
                  _SectionHeader(
                    ...
                    label: context.l10n.offersTopDeals,
                    trailing: TextButton(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          AppSpacing.vGapMd,
          Text(
            context.l10n.offersMegaSavings,
            style:
                AppTypography.displayMedium.copyWith(color: AppColors.white),
          ),
          AppSpacing.vGapXs,
          Text(
            context.l10n.offersUpTo60OffProduce,
...
class _FilterChips extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final labels = [
      context.l10n.offersFilterFlashSale,
      context.l10n.offersFilterTopDiscounts,
      context.l10n.offersFilterBuy1Get1,
    ];
    return SizedBox(
      height: 36,
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        context.l10n.offersOnlyFiveLeft,
                        style: AppTypography.labelSmall.copyWith(color: vs.offer),
                      ),
                      const Spacer(),
                      Text(
                        context.l10n.offersClaimedPercent,
                      ...
                      children: [
                        if (offer.savings > 0)
                          Expanded(
                            child: VSStatusChip(
                              label: context.l10n
                                  .productSave(offer.savings.asCurrency),
