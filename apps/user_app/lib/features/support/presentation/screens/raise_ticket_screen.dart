...
class _RaiseTicketScreenState extends ConsumerState<RaiseTicketScreen> {
  ...
  /// Images picked for this ticket; uploaded to /media on submit and attached to
  /// the opening message.
  ...
  Future<void> _addAttachment() async {
    if (_attachments.length >= 3) {
      context.showSnack(context.l10n.supportAttachLimit);
      return;
    }
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      // Upload any picked images first so the opening message can carry their URLs.
      final attachments = <Map<String, dynamic>>[];
      for (final file in _attachments) {
        attachments.add(await ds.uploadAttachment(file.path));
      }
      ...
      if (!mounted) return;
      context.showSnack(context.l10n.supportTicketSubmitted);
      context.pop();
    } catch (e) {
      if (!mounted) return;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: VSAppBar(title: context.l10n.supportRaiseTicket),
      body: SafeArea(
        child: Column(
          children: [
            Expanded(
                    ...
                    children: [
                      _SectionCard(
                        child: _DropdownField(
                          label: context.l10n.supportIssueCategory,
                          required: true,
                      ...
                      _SectionCard(
                        child: _DropdownField(
                          label: context.l10n.supportRelatedOrder,
                          hint: 'None',
                          value: relatedValue,
                          items: orderCodes,
                          onChanged: (v) =>
                      ...
                      _SectionCard(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(context.l10n.supportPriorityLevel,
                      ...
                      _SectionCard(
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                _RequiredLabel(context.l10n.supportIssueDescription),
                                const Spacer(),
                                Text(
                            ...
                            VSTextField(
                              ...
                              hint: context.l10n.supportDescribeIssue,
                              maxLines: 5,
                      ...
                      _SectionCard(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(context.l10n.supportAttachments,
                                style: AppTypography.labelLarge),
                            AppSpacing.vGapMd,
                            _AttachmentBox(
                              files: _attachments,
...
/// Dashed-look tappable box prompting the user to upload files. Controlled by
/// the parent form: tapping it asks the parent to pick an image (via [onAdd]),
/// and the picked [files] are uploaded to /media on submit and attached to the
/// ticket's opening message. [onRemove] drops one before submitting.
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  AppSpacing.vGapSm,
                  Text(
                    context.l10n.supportTapToUploadPhotos,
                    style: AppTypography.labelMedium.copyWith(color: vs.trust),
                  ),
                  AppSpacing.vGapXs,
                  Text(
                    context.l10n.supportMaxFilesSize,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return _SectionCard(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(context.l10n.supportContactInfo,
              style: AppTypography.labelLarge),
          AppSpacing.vGapMd,
          _ContactRow(
            icon: Icons.smartphone_outlined,
            label: context.l10n.supportRegisteredMobile,
            value: phone,
          ),
          AppSpacing.vGapMd,
          _ContactRow(
            icon: Icons.mail_outline_rounded,
            label: context.l10n.supportRegisteredEmail,
            value: email,
          ),
        ],
      ),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(context.l10n.supportResponseTime,
                    style: AppTypography.labelLarge.copyWith(color: vs.trust)),
                AppSpacing.vGapXs,
                Text(
                  context.l10n.supportRespondsWithin24h,
      ...
      child: Row(
        children: [
          ...
          Expanded(
            flex: 2,
            child: VSButton(
                label: context.l10n.supportSubmitTicket, onPressed: onSubmit),
          ),
        ],
      ),
    );
