...
/// Localized label for a [_TicketStatus] (the enum's [label] is English-only).
String _statusLabel(BuildContext context, _TicketStatus status) =>
    switch (status) {
      _TicketStatus.open => context.l10n.supportStatusOpen,
      _TicketStatus.inProgress => context.l10n.supportStatusInProgress,
      _TicketStatus.resolved => context.l10n.supportStatusResolved,
      _TicketStatus.closed => context.l10n.supportStatusClosed,
    };

/// Localized label for a [_TicketFilter] tab.
String _filterLabel(BuildContext context, _TicketFilter filter) =>
    switch (filter) {
      _TicketFilter.all => context.l10n.catalogAll,
      _TicketFilter.open => context.l10n.supportStatusOpen,
      _TicketFilter.inProgress => context.l10n.supportStatusInProgress,
      _TicketFilter.resolved => context.l10n.supportStatusResolved,
      _TicketFilter.closed => context.l10n.supportStatusClosed,
    };

String _updatedLabel(BuildContext context, SupportTicket t) {
  const months = [
    '', 'Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun',
    'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'
  ];
  final d = t.createdAt;
  return '${context.l10n.supportCreated} ${d.day} ${months[d.month]} ${d.year}';
}
...
class _TicketHistoryScreenState extends ConsumerState<TicketHistoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: VSAppBar(title: context.l10n.supportMyTickets),
      body: SafeArea(
        top: false,
        child: ticketsAsync.when(
          ...
          error: (e, _) => VSErrorView(
            ...
            message: e is Failure ? null : "Couldn't load your tickets.",
                  ...
                  if (filtered.isEmpty)
                    Padding(
                      ...
                      child: VSEmptyState(
                        ...
                        title: context.l10n.supportNoTickets,
                        message: context.l10n.supportNoTicketsCategory,
                      ),
                    )
                  else
      ...
      child: ListView(
        ...
        children: [
          _SummaryCard(
            ...
            label: context.l10n.supportStatusOpen,
            count: open,
