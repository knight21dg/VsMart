      ...
      builder: (ctx) => SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(context.l10n.supportTicketCode(ticket.id),
                  style: AppTypography.titleLarge),
              AppSpacing.vGapMd,
              _detailRow('Status', _statusLabel(context, ticket.status)),
              _detailRow('Priority', _titleCase(ticket.priority)),
              _detailRow(context.l10n.supportCategory, ticket.category),
      ...
      return Scaffold(
        appBar: VSAppBar(
          titleWidget: _ConversationTitle(
            title: context.l10n.supportNewConversation,
            subtitle: context.l10n.supportTypicalReply,
          ),
        ),
        body: SafeArea(
          top: false,
            ...
            children: [
              Expanded(
                child: VSEmptyState(
                  ...
                  title: context.l10n.supportStartConversation,
                  message:
      ...
      appBar: VSAppBar(
        titleWidget: _ConversationTitle(
          ...
          subtitle: ticketAsync.maybeWhen(
            data: (t) =>
                'Ticket VS-TKT-${t.id} • ${_statusLabel(context, t.status)}',
...
String _statusLabel(BuildContext context, String s) => switch (s) {
      'in_progress' => context.l10n.supportStatusInProgress,
      'resolved' => context.l10n.supportStatusResolved,
      'closed' => context.l10n.supportStatusClosed,
      _ => context.l10n.supportStatusOpen,
    };
  ...
  Widget build(BuildContext context) {
    ...
    if (messages.isEmpty) {
      return VSEmptyState(
        ...
        title: context.l10n.supportNoMessages,
        message: context.l10n.supportSendToStart,
      );
    }
    ...
    final items = <Widget>[];
    DateTime? lastDay;
    items.add(_DateSeparator(label: context.l10n.supportTicketOpened(ticket.id)));
              ...
              child: Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: context.l10n.supportTypeMessage,
