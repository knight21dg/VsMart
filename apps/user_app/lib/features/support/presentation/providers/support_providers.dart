...
/// Platform-wide fallback support contact (public).
final supportContactProvider = FutureProvider<SupportContact>(
  (ref) => ref.watch(supportDataSourceProvider).getContact(),
);
