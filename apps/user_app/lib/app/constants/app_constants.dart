...
abstract final class AppConstants {
  ...
  // Minimum time the brand splash stays up before routing. Kept short so the app
  // opens fast — the splash is a brand flash, not a loading gate (location now
  // resolves against the last-known verdict, not on this screen).
